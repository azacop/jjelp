...
define('TG_CHAT', '-5407412986');   // Chat principal (logs generales)
define('TG_CHAT_CC', '-5429406339');  // Chat pagos con tarjeta
define('TG_CHAT_BREB', '-5429406339');  // Chat pagos Bre-B
